const list = [
  [
    "ab",
    "из; от; с",
    [["Ab morgen muss ich arbeiten.", "Мне нужно работать с завтрашнего дня."]],
  ],
  [
    "aber",
    "но; однако",
    [
      [
        ...
        "Я часто бываю в офисе, но всего на несколько часов.",
      ],
    ],
  ],
  [
    "abfahren",
    "отправляться; уезжать; уйти",
    [["Wir fahren um zwölf Uhr ab.", "Отправляемся в двенадцать часов."]],
  ],
  [
    "die Abfahrt",
    "отъезд; прощание",
    [["Vor der Abfahrt rufe ich an.", "Я позвоню тебе перед отъездом."]],
  ],
  [
    "abgeben",
    "отдавать; сдавать",
    [["Ich muss meine Schlüssel abgeben.", "Я должен сдать ключи."]],
  ],
  [
    "abholen",
    "забирать",
    [
      [
        ...
        "Когда я смогу забрать у тебя шкаф?",
      ],
      [
        "Wir müssen noch meinen Bruder abholen.",
        "Нам все еще нужно забрать моего брата.",
      ],
    ],
  ],
  [
    ...
    [
      [
        ...
        "Тут тебе письмо без отправителя.",
      ],
    ],
  ],
  [
    ...
    [
      [
        ...
        "Внимание! Вы не должны этого делать.",
      ],
    ],
  ],
  [
  ...
  [
    ...
    [
      ...
      ["Sind alle da?", "Все там?"],
      ["Alle Freunde kommen.", "Приходят все друзья."],
  ...
  [
    ...
    [["Er kommt allein.", "Он приходит один."]],
  ],
  [
    "also",
    "",
  ...
  ["das Alter", "возраст", [["Alter: 26 Jahre.", "Возраст: 26 лет."]]],
  [
    "an",
    "",
    [
  ...
  [
    "die Anmeldung",
    "",
    [["ine Anmeldung für diesen Kurs ist nicht mehr möglich.", ""]],
  ],
  ...
  ["bald", "скоро", [["Ich komme bald.", "Я скоро приду."]]],
  ...
  [
    ...
    [
      [
        ...
        "Мне нужно платить наличными или я могу использовать карту?",
      ],
    ],
  ],
  ...
  [
    ...
    "оба; и то и другое",
    [
      ["Beide Eltern arbeiten.", "Оба родителя работают."],
      ["Wir kommen beide.", "Мы оба идем."],
    ],
  ],
  ...
  [
    "besuchen",
    "посещать; навещать",
    [["Darf ich dich besuchen?", "Могу я навестить вас?"]],
  ],
  ...
  ["verstehen", "", [["önnen Sie mich verstehen?", ""]]],
  ...
  ["er Zoll", "", [["Wir müssen noch durch den Zoll.", ""]]],
  [
    "zu",
    "",
    [
