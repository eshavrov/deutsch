...
export interface definitions {
  ...
  productModifier_Base: {
    /**
     * Main API, which determines how it will display on the storefront. Acceptable values: `date`, `checkbox`, `file`, `text`, `multi_line_text`, `numbers_only_text`, `radio_buttons`, `rectangles`, `dropdown`, `product_list`, `product_list_with_images`, `swatch`. Required in a /POST.
     */
    type:
      | "date"
      | "checkbox"
  ...
  categoriesTreeNode_Full: {
    ...
    name?: string;
    /**
     * Flag to determine whether the product should be displayed to users browsing the store. If `true`, the category will be displayed. If `false`, the category will be hidden from view.
     */
    is_visible?: boolean;
    /**
  ...
  productImage_Base: {
    /**
     * The local path to the original image file uploaded to Main.
     */
    image_file?: string;
    /**
  ...
  customUrl_Full: {
    ...
    url?: string;
    /**
     * Returns `true` if the URL has been changed from its default state (the auto-assigned URL that BigBase provides).
     */
  ...
  /**
   * Errors during batch usage for the Main API.
   */
  ...
  /**
   * Error payload for the Main API.
   */
  error_Base: {
    /**
  ...
  /**
   * No-content response for the Main API.
   */
  errorNoContent: {
    /**
  ...
  product_Base: {
    ...
    tax_class_id?: number;
    /**
     * Accepts AvaTax System Tax Codes, which identify products and services that fall into special sales-tax categories. By using these codes, merchants who subscribe to BigBase's Avalara Premium integration can calculate sales taxes more accurately. Stores without Avalara Premium will ignore the code when calculating sales tax. Do not pass more than one code. The codes are case-sensitive. For details, please see Avalara's documentation.
     */
    ...
    is_free_shipping?: boolean;
    /**
     * Flag to determine whether the product should be displayed to users browsing the store. If `true`, the product will be displayed. If `false`, the product will be hidden from view.
     */
    is_visible?: boolean;
    /**
    ...
    /**
     * Availability text displayed on the checkout page, under the product title. Tells the user how long it will normally take to ship this product, such as: 'Usually ships in 24 hours.'
     */
    ...
    /**
     * Flag used to determine whether the product condition is shown to the user on the product page.
     */
