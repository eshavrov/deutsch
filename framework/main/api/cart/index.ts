...
export type CartHandlers = {
  getCart: MainHandler<Cart, { cartId?: string }>;
  addItem: MainHandler<Cart, { cartId?: string } & Partial<AddItemBody>>;
  updateItem: MainHandler<Cart, { cartId?: string } & Partial<UpdateItemBody>>;
  removeItem: MainHandler<Cart, { cartId?: string } & Partial<RemoveItemBody>>;
};

const METHODS = ["GET", "POST", "PUT", "DELETE"];

// TODO: a complete implementation should have schema validation for `req.body`
const cartApi: MainApiHandler<Cart, CartHandlers> = async (
  req,
  res,
  config,
  handlers
